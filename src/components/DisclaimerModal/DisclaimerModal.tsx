    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Fries protocol have made
      ...
      return (
        <div>
          <p>Attention FRIES Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with FRIES is FRIES/yCRV
            (Curve yPool tokens)
          </p>
