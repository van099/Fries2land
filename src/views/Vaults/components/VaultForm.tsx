...
const VaultForm: React.FC<VaultProps> = ({ vaultData, expanded, setExpanded, roundId, totalValue, poolAmount, tvlWeight }) => {
  ...
  useEffect(() => {
    ...
    if (poolAmount.toString() != '0') {
      ...
      const newValutAPY = compound(vaultAPR.toNumber(), Number(process.env.REACT_APP_COMPOUND_APCT), 365, Number(process.env.REACT_APP_COMPOUND_TIMES_PER_DAY))
