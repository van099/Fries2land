...
import { getSupportedVaultsv2 } from '../../fries/utils'

import { makeStyles } from '@material-ui/core/styles';

import Vaultv2Form from './components/Vaultv2Form'
...
const Farm: React.FC = () => {
  ...
  const totalValues = useVaultsv2TVL()
      ...
      {!!account ? (
        <>
          <PageHeader
            ...
            title={"Fry World Pancake LP VaultsV2"}
            subtitle="This project is in beta. (Withdrawal Fee: 0.05%)"
            isIcon={0}
