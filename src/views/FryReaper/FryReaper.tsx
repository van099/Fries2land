...
import { getSupportedReapers } from '../../fries/utils'

import { makeStyles } from '@material-ui/core/styles';

import ReaperForm from './components/ReaperForm'

import fryreaper from '../../assets/img/fryreaper.png'
...
const Farm: React.FC = () => {
  ...
  const totalValues = useReapersTVL()
  ...
  return (
    <Page>
      {!!account ? (
        <>
          <PageHeader
            icon={<img src={fryreaper} height="120" />}
            title="Fry World Reaper"
